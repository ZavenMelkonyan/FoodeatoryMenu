...
namespace FoodetoryMenuGeorgian.Models.Georgian
{
    public class Categories
    {
        ...
        public Categories()
        {
            ...
            khachapuri.Add(new Product { Name = "Imeretian whole", NameArm = "Իմերիթական ամբողջ", NameRus = "Имеритинский целая", Price = "1500/350", PicPath = "/Resources/Georgian/Իմերիթական ամբողջ.jpg", Description = "cheese, egg, butter, flour, suluguni, chanakh", DescriptionArm = "պանիր, ձու, կարագ, ալյուր, սուլուգունի, չանախ", DescriptionRus = "сыр, яйцo, масло сливочное, мука, сулугуни, чанах" });
            ...
            khachapuri.Add(new Product { Name = "Megrelian whole", NameArm = "Մեգրելական ամբողջ", NameRus = "Мегрельский целая", Price = "1800/450", PicPath = "/Resources/Georgian/Մեգրելական ամբողջ.jpg", Description = "cheese, egg, butter, flour, suluguni, chanakh", DescriptionArm = "պանիր, ձու, կարագ, ալյուր, սուլուգունի, չանախ", DescriptionRus = "сыр, яйцо, масло сливочное, мука, сулугуни, чанах" });
