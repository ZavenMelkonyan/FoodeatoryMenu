...
namespace FoodetoryMenuGeorgian.Models.Steak
{
    public class Categories
    {
        ...
        public Categories()
        {
            ...
            categories.Add(new Categorie { Name = "Steak", NameArm = "Սթեյք", NameRus = "Стейк", Products = steak });
            ...
            categories.Add(new Categorie { Name = "Burger", NameArm = "Բուրգեր", NameRus = "Бургеры", Products = burger });
            ...
            categories.Add(new Categorie { Name = "Sandwich", NameArm = "Սենդվիչներ", NameRus = "Сэндвичи", Products = sandwich });

            List<Product> mainDishes = new List<Product>();

            mainDishes.Add(new Product { Name = "Chicken drumstick (2/4/6 pieces)", NameArm = "Հավի բդիկ 2/4/6 հատ", NameRus = "Куриные бёдрышки 2/4/6 шт.", Price = "950/1850/2650", PicPath = "/Resources/Steak/Chicken drumsticks 2 pieces.jpg", Description = "chicken legs, flour, breading, salt, pepper", DescriptionArm = "հավի բդիկ, ալյուր, պաքսիմատ, աղ, պղպեղ ", DescriptionRus = "куриные окорочки, мука, панировка, соль, перец" });
            mainDishes.Add(new Product { Name = "Chicken wings (3/6/9 pieces)", NameArm = "Հավի թևիկ 3/6/9 հատ", NameRus = "Куриные крылышки 3/6/9 шт.", Price = "950/1550/2350", PicPath = "/Resources/Steak/Chicken wings 3 pieces.jpg", Description = "chicken wings, flour, breading, salt, pepper", DescriptionArm = "հավի թևիկ, ալյուր, պաքսիմատ, աղ, պղպեղ ", DescriptionRus = "куриные крылышки, мука, панировка, соль, перец" });
            mainDishes.Add(new Product { Name = "Chicken nuggets (4/8/12 pieces)", NameArm = "Նագետ 4/8/12 հատ", NameRus = "Наггетсы 4/8/12 шт.", Price = "950/1600/2500", PicPath = "/Resources/Steak/Chicken nuggets 4 pieces.jpg", Description = "chicken breast, flour, breading, salt, pepper", DescriptionArm = "հավի  կրծքամիս, ալյուր, պաքսիմատ, աղ, պղպեղ ", DescriptionRus = "куриная грудка, мука, панировка, соль, перец" });
            mainDishes.Add(new Product { Name = "Chicken sticks (small, big)", NameArm = "Հավի ձողիկներփոքր / մեծ", NameRus = "Куриные палочки(маленькая/ большая порция)", Price = "950 / 1200", PicPath = "/Resources/Steak/Chicken sticks big.jpg", Description = "chicken breast, flour, breading, salt, pepper", DescriptionArm = "հավի կրծքամիս, ալյուր, պաքսիմատ, աղ, պղպեղ ", DescriptionRus = "куриная грудка, мука, панировка, соль, перец" });
            mainDishes.Add(new Product { Name = "French fries (small, big)", NameArm = "Ֆրի փոքր/մեծ", NameRus = "Картофель фри (маленькая/большая порция)", Price = "450/550", PicPath = "/Resources/Steak/French fries big.jpg", Description = "potatoes", DescriptionArm = "կարտոֆիլ", DescriptionRus = "картофель" });
            ...
            categories.Add(new Categorie { Name = "Main dishes", NameArm = "Հիմնական ուտեստներ", NameRus = "Основные блюда", Products = mainDishes });
