using FoodetoryMenuGeorgian.Models.ItalyUA;
...
{
    public class ItalyUAController : Controller
    {
        [Route("/ItalyUA")]
        public IActionResult ItalyUA(FoodetoryMenuGeorgian.Models.HomeViewModel homeViewModel)
        {
            GeorgianUAViewModel barViewModel = new GeorgianUAViewModel() { categories = new Categories() };
            barViewModel.isQR = homeViewModel.isQR;
            return View("italyua", barViewModel);
        }
        [Route("/ItalyUA_eng")]
        public IActionResult ItalyUAEng(FoodetoryMenuGeorgian.Models.HomeViewModel homeViewModel)
        {
            GeorgianUAViewModel barViewModel = new GeorgianUAViewModel() { categories = new Categories() };
            barViewModel.isQR = homeViewModel.isQR;
            return View("italyua_eng", barViewModel);
        }
