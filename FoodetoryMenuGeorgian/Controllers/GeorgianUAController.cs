using FoodetoryMenuGeorgian.Models.GeorgianUA;
...
{
    public class GeorgianUAController : Controller
    {
        [Route("/GeorgianUA")]
        public IActionResult GeorgianUA(FoodetoryMenuGeorgian.Models.HomeViewModel homeViewModel)
        {
            GeorgianUAViewModel barViewModel = new GeorgianUAViewModel() { categories = new Categories() };
            barViewModel.isQR = homeViewModel.isQR;
            return View("georgianua", barViewModel);
        }
        [Route("/GeorgianUA_eng")]
        public IActionResult GeorgianUAEng(FoodetoryMenuGeorgian.Models.HomeViewModel homeViewModel)
        {
            GeorgianUAViewModel barViewModel = new GeorgianUAViewModel() { categories = new Categories() };
            barViewModel.isQR = homeViewModel.isQR;
            return View("georgianua_eng", barViewModel);
        }
