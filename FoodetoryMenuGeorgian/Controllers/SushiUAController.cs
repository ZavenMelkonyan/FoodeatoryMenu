...
using FoodetoryMenuGeorgian.Models.SushiUA;

namespace FoodetoryMenuGeorgian.Controllers
{
    public class SushiUAController : Controller
    {
        [Route("/SushiUA")]
        public IActionResult SushiUA(FoodetoryMenuGeorgian.Models.HomeViewModel homeViewModel)
        {
            GeorgianUAViewModel barViewModel = new GeorgianUAViewModel() { categories = new Categories() };
            barViewModel.isQR = homeViewModel.isQR;
            return View("sushiua", barViewModel);
        }
        [Route("/SushiUA_eng")]
        public IActionResult SushiUAEng(FoodetoryMenuGeorgian.Models.HomeViewModel homeViewModel)
        {
            GeorgianUAViewModel barViewModel = new GeorgianUAViewModel() { categories = new Categories() };
            barViewModel.isQR = homeViewModel.isQR;
            return View("sushiua_eng", barViewModel);
        }
